  ...
  return (
    <header className={roboto.className}>
      <nav className="flex items-center flex-row justify-between px-4 py-3 sm:px-8 min-h-[100px] max-h-[100px]">
        ...
        <div className="hidden md:flex flex-row min-w-fit max-w-fit justify-center items-center gap-3 " id="login">
          <p>Já possui conta?</p>
        ...
        <div className="flex items-center space-x-4" onClick={toggleMenu}>
          <div className="md:hidden" id="hamburguer-icon">
            <button
              type="button"
          ...
          <div className="hidden md:flex items-center gap-16" id="accessibilitys-icon">
